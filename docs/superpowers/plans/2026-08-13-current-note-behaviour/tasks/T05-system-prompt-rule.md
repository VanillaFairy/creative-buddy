...
is where you look. Take what they say as being about that note, and look past it to
the rest of the graph only when it plainly is not about that note — "answer the
second one" means the second question on that note, and "what did we decide about
the ending?" asked over a character note is still about the ending.
